...
-- public.host_organizer definition

-- Drop table

-- DROP TABLE public.host_organizer;

CREATE TABLE public.host_organizer (
	...
	create_quiz bool DEFAULT false NOT NULL,
	edit_quiz bool DEFAULT false NOT NULL,
	delete_quiz bool DEFAULT false NOT NULL,
	CONSTRAINT host_organizer_pkey PRIMARY KEY (host_id, organizer_id),
	CONSTRAINT host_organizer_host_id_fkey FOREIGN KEY (host_id) REFERENCES public."user"(id) ON DELETE CASCADE,
	CONSTRAINT host_organizer_organizer_id_fkey FOREIGN KEY (organizer_id) REFERENCES public.organizer(id) ON DELETE CASCADE
);
...
CREATE TABLE public.quiz (
	...
	CONSTRAINT quiz_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.quiz_category(id) ON DELETE CASCADE,
	CONSTRAINT quiz_location_id_fkey FOREIGN KEY (location_id) REFERENCES public."location"(id) ON DELETE CASCADE,
	CONSTRAINT quiz_owner_id_fkey FOREIGN KEY (organizer_id) REFERENCES public.organizer(id) ON DELETE CASCADE
);
...
CREATE TABLE public.quiz_edition (
	...
	CONSTRAINT quiz_edition_host_fkey FOREIGN KEY (host) REFERENCES public."user"(id) ON DELETE CASCADE,
...
CREATE TABLE public.quiz_segment (
	...
	bonus_points int4 DEFAULT 0 NULL,
